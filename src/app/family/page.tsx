      ...
      <AppHeader
        ...
        rightAction={
          <button
            ...
            style={{ background: 'linear-gradient(135deg, #7C5CFC 0%, #5A32FA 100%)' }}
          >
            <span>+</span> 초대
          </button>
        }
        ...
        <>
              ...
              {members.map((member) => (
                ...
                >
                  <div
                    ...
                    style={{ background: 'rgba(90,50,250,0.08)' }}
                  >
                    {member.avatar}
                  </div>
                  ...
                  <span
                    ...
                    style={{
                      background: member.role === 'parent' ? 'rgba(90,50,250,0.10)' : 'rgba(16,185,129,0.10)',
                      color:      member.role === 'parent' ? '#5A32FA' : '#059669',
                      fontFamily: "'Noto Sans KR',sans-serif",
                    }}
                  >
          ...
          <div className="mx-4 mt-4">
            <button
              ...
              style={{
                border: '1.5px dashed rgba(90,50,250,0.25)',
                color: '#5A32FA',
                fontFamily: "'Noto Sans KR',sans-serif",
                background: 'rgba(90,50,250,0.04)',
              }}
            >
              다른 가족 그룹에 합류하기
            </button>
        ...
        <div className="fixed inset-0 z-50 flex items-end justify-center" style={{ background: 'rgba(0,0,0,0.5)' }}
          ...
          <div className="w-full max-w-[430px] bg-white rounded-t-[32px] p-6 pb-10" onClick={(e) => e.stopPropagation()}>
            ...
            <button
              ...
              style={{
                background: copied ? 'rgba(16,185,129,0.06)' : 'rgba(90,50,250,0.06)',
                border: `1.5px solid ${copied ? 'rgba(16,185,129,0.20)' : 'rgba(90,50,250,0.15)'}`,
              }}
            >
              <div
                className="w-11 h-11 rounded-full flex items-center justify-center text-xl flex-shrink-0"
                style={{ background: copied ? 'rgba(16,185,129,0.12)' : 'rgba(90,50,250,0.10)' }}
              >
                {copied ? '✅' : '🔗'}
              </div>
              <div className="text-left flex-1 min-w-0">
                <p className="text-[15px] font-semibold" style={{ color: copied ? '#059669' : '#5A32FA', fontFamily: "'Noto Sans KR',sans-serif" }}>
            ...
            {group?.inviteCode && (
              <div
                ...
                style={{ background: '#FAFAFD', border: '1.5px solid rgba(90,50,250,0.10)' }}
              >
                <div
                  className="w-11 h-11 rounded-full flex items-center justify-center text-xl flex-shrink-0"
                  style={{ background: 'rgba(90,50,250,0.08)' }}
                ...
                <div>
                  ...
                  <p className="text-[18px] font-mono font-bold" style={{ color: '#5A32FA' }}>
                    {group.inviteCode}
                  </p>
                </div>
              </div>
        ...
        <div className="fixed inset-0 z-50 flex items-end justify-center" style={{ background: 'rgba(0,0,0,0.5)' }}
          ...
          <div className="w-full max-w-[430px] bg-white rounded-t-[32px] p-6 pb-10" onClick={(e) => e.stopPropagation()}>
            ...
            <input
              ...
              style={{
                borderColor: joinError ? '#EF4444' : joinCode ? '#5A32FA' : '#E5E5EA',
            ...
            <div className="grid grid-cols-2 gap-3 mt-3">
              ...
              <button onClick={handleJoin} disabled={joining || !joinCode.trim()}
                ...
                style={{ background: 'linear-gradient(135deg, #7C5CFC 0%, #5A32FA 100%)', fontFamily: "'Noto Sans KR',sans-serif" }}>
                {joining ? '확인 중...' : '합류하기'}
              </button>
            </div>
          </div>
