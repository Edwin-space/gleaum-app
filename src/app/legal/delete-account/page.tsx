...
export default function DeleteAccountPage() {
  return (
    <div style={{ minHeight: '100dvh', background: 'var(--theme-bg)', fontFamily: "'Pretendard', sans-serif" }}>
      {/* 헤더 */}
      <div style={{ background: 'var(--theme-surface)', borderBottom: '1px solid #F0F0F5', padding: '16px 20px', display: 'flex', alignItems: 'center', gap: '12px', position: 'sticky', top: 0, zIndex: 10 }}>
        <Link href="/legal/privacy" style={{ color: 'var(--theme-text)', textDecoration: 'none', fontSize: '22px', lineHeight: 1 }}>←</Link>
        <h1 style={{ margin: 0, fontSize: '17px', fontWeight: 700, color: 'var(--theme-text)' }}>계정 및 데이터 삭제 요청</h1>
      </div>
      ...
      <div style={{ maxWidth: '720px', margin: '0 auto', padding: '32px 20px 80px' }}>
        ...
        <section style={{ marginBottom: '36px' }}>
          <h2 style={{ fontSize: '16px', fontWeight: 700, color: 'var(--theme-text)', marginBottom: '12px', paddingBottom: '8px', borderBottom: '1px solid #EEEEF5' }}>
          ...
          <div style={{ fontSize: '14px', lineHeight: '1.75', color: '#3A3A4A' }}>
            ...
            <div style={{ background: '#F5F5FB', borderRadius: '12px', padding: '16px 20px', margin: '16px 0' }}>
              <p style={{ margin: 0, fontSize: '14px', fontWeight: 700, color: 'var(--theme-text)' }}>삭제 경로</p>
        ...
        <section style={{ marginBottom: '36px' }}>
          ...
          <div style={{ fontSize: '14px', lineHeight: '1.75', color: '#3A3A4A' }}>
            ...
            <div style={{ background: '#F5F5FB', borderRadius: '12px', padding: '16px 20px', margin: '16px 0' }}>
              <p style={{ margin: 0, fontSize: '14px', fontWeight: 700, color: 'var(--theme-text)' }}>이메일 요청 시 포함할 내용</p>
            ...
            <div style={{ background: 'var(--theme-surface)', borderRadius: '10px', padding: '14px 18px', border: '1px solid #EEEEF5', marginTop: '12px' }}>
              <p style={{ margin: 0, fontSize: '14px', color: 'var(--theme-text)' }}>
