...
2026-06-22에 `NativeHomePortActivity` 비활성 skeleton을 Mobile Web 홈 순서 기준으로 보강했다.
...
- 실제 API 연동, 세션 라우팅, MainActivity 진입 연결은 아직 하지 않음
- Android `:app:assembleDebug` 통과

다음 단계:

- Mobile Web 홈 실제 캡처와 Native skeleton 시각 비교
