...
- **최신 배포**: 2026-07-23 Vercel Production `dpl_Gc7Dmx7ahfUVTw7qvnEY7GYEzLfr`. 보호자 이메일 6자리 OTP 입력·DB 증적 강제, 가족 관계/공간 권한 분리와 자녀 초대 WebView 경로 유지 보정, 기존 Android 가족 공간 전환·광고 capability 보정, Next 16.2.11 포함
