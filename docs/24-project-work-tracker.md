...
| [ ] | `FAM-011` | 보호자 이메일 OTP·필수 동의 정합화 | `🟠 실메일 회귀 대기` | 2026-07-23 | — | 6자리 OTP UI/API, 확인 증적 DB 강제, `email_otp` 이력, migration·Production·Supabase Auth 제목/HTML 운영 적용 완료. 실제 수신 코드와 필수 동의 완료만 확인 필요 |
