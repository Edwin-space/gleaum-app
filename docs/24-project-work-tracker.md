...
> 최초 작성: 2026-07-16
> 최종 업데이트: 2026-07-16
> 현재 Git 기준점: `8fc41c6` (`main`) + 대규모 미커밋 작업 트리
...
| 9 | `REPO-001` | 현재 대규모 미커밋 작업 안전한 체크포인트 | `🟠 진행 중` | Android 제외, Web·API/백오피스/DB/문서를 도메인별 검증·커밋 |
...
| [ ] | `REPO-001` | 기존 미커밋 변경 검토·안전한 커밋 분리 | `🟠 진행 중` | 2026-07-16 | — | 사용자 지시에 따라 Android 파일·검증은 제외. Web·API/백오피스/DB/문서를 기능 단위로 검증하고 운영 반영 보안 변경부터 체크포인트 커밋 |
