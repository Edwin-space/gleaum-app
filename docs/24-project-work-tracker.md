...
| [ ] | `AND-006` | Play Console 출시 자료·정책 점검 | `⏸ 보류` | 2026-07-16 | — | 사용자 결정으로 후순위. 기능 안정화 뒤 `docs/25-google-play-release-readiness.md` 기준 Console 최신 versionCode·IARC·App access·서명·스토어 자료 확인 |
