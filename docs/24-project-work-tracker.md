...
| [ ] | `IOS-011` | iPhone·테마·접근성 QA | `🟠 핵심 화면 통과·iPad 후순위` | 2026-07-28 | — | 일정·공간·가계부·알림·전체 메뉴·가족/자녀를 iPhone 17 Pro 라이트/다크와 접근성 큰 글자에서 검증했다. 시스템 의미 색상, SF Symbols, Dynamic Type과 스크롤 가능한 시스템 목록을 유지한다. 소형/대형 iPhone, Reduce Motion·오프라인/세션·VoiceOver 실음성 회귀가 남음. iPad·Split View는 후순위 |
