...
글리움(Gleaum)은 반짝이는 빛(**Gleam**) + 기록(**글**) + 공간(**-ium**)의 합성어입니다.
디자인 철학은 복잡한 가족의 일상을 **'가장 맑고 투명하게, 그리고 부드럽게'** 연결하는 것입니다.
프리미엄 글래스모피즘(Glassmorphism)과 생동감 있는 오리지널 컬러(Green/Teal/Blue)를 결합하여
사용자에게 심리적 안정감과 즐거움을 동시에 제공합니다.
